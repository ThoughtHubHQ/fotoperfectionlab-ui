...
const faqData = [
  {
    ...
    answer:
      "Our standard turnaround time is 24 to 48 hours, depending on the complexity and volume of the project. For urgent requirements, we also offer expedited delivery options.",
  },
  {
    id: 2,
    question: "Do you offer a free trial or sample edit?",
    answer:
      "Yes, we offer a free trial for up to 3 images. This allows you to evaluate our quality, communication, and turnaround time before committing to a larger project.",
  },
  {
    id: 3,
    question: "What file formats do you accept and deliver?",
    answer:
      "We accept all major formats including RAW, JPEG, PNG, TIFF, and PSD. We deliver the final edited images in your preferred format and required specifications.",
  },
  {
    id: 4,
    question: "Do you provide bulk discounts for large orders?",
    answer:
      "Absolutely. We offer customized pricing and significant discounts for bulk orders and ongoing monthly retainers. Please contact us with your estimated volume for a tailored quote.",
  },
  {
    id: 5,
    question: "What is your revision policy if I am not satisfied?",
    answer:
      "We offer unlimited revisions until you are 100% satisfied with the final result. Your dedicated project manager will ensure all feedback is implemented precisely.",
  },
];
      ...
      <div className="max-w-260 mx-auto px-4 md:px-8 xl:px-0 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <p className="text-[#6B7280] text-[14px] md:text-[15px] font-medium max-w-125">
            Find answers to common questions about our photo editing and
            retouching services.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between p-5 md:p-7">
                  <h3
                    className={`text-[15px] md:text-[17px] font-bold tracking-tight pr-4 transition-colors duration-300 ${
                ...
                <div
                  className={`grid transition-all duration-300 ease-in-out ${
                    isOpen
                      ? "grid-rows-[1fr] opacity-100 mb-5 md:mb-7"
