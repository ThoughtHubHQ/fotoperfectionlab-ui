    ...
    <section className="w-full py-16 lg:py-24 bg-transparent">
      <div className="max-w-360 mx-auto px-4 md:px-8 xl:px-16 2xl:px-0 flex flex-col gap-20">
        ...
        <div className="w-full flex flex-col">
          ...
          {/* Grid Container */}
          <div className="w-full rounded-3xl md:rounded-4xl border border-[rgba(37,99,235,0.20)] bg-[rgba(37,99,235,0.03)] overflow-hidden shadow-[0_4px_40px_0_rgba(41,98,255,0.03)]">
        ...
        <div className="w-full flex flex-col">
          ...
          {/* Cards Grid */}
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 xl:px-20">
